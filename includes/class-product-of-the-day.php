...
class Product_Of_The_Day {
	...
	private function load_dependencies() {
		...
		/**
		 * The class file for common functionalities
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-product-of-the-day-common.php';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_init', $plugin_admin, 'update_product_of_the_day_settings' );
		$this->loader->add_action( 'init', $plugin_admin, 'product_of_the_day_post_type_registration' );
		$this->loader->add_action( 'save_post', $plugin_admin, 'save_product_of_the_day_field' );
		$this->loader->add_action( 'admin_init', $plugin_admin, 'add_product_of_the_day_metabox' );
		$this->loader->add_action( 'manage_posts_custom_column', $plugin_admin, 'add_product_of_the_day_column',10, 2 );
		
		$this->loader->add_filter( 'manage_product_of_the_day_posts_columns', $plugin_admin, 'filter_product_of_the_day_columns' );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter( 'the_content', $plugin_public, 'track_page_click' );
